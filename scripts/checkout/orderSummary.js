...
export function renderOrderSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    function deliveryOptionsHTML(matchingProduct,cartItem) {
      ...
      document.querySelector('.js-order-summary').innerHTML = carySummaryHTML;
      ...
      function updateCartQunatity() {
        ...
        if (returnLink) {
            ...
            console.error('.js-return-to-home-link not found in DOM');
        }
      ...
      document.querySelectorAll('.js-update-link').forEach((link) =>{
        link.addEventListener('click' ,() => {
          ...
          //making class not directly invloved as we want to make it appear by on click
